...
export default function BasicModal() {
  ...
  //    var data = [""];
  //    await axios
  //      .get("http://67.205.163.34:8000/regions/cities")
  //      .then((res) => {
    ...
    <>
      <div>
        <div class="row">
          ...
          {sessionStorage.getItem("mt&*&A*Sdzd090@#@QOkkllkdIQO@D!(090>>,@Ors") == "MMIDZIdhasHUD*Y@Y10y1yayd8a9sd8adaDH(!(2iksjadsadjaJDAODOAWIi@i" ? (
